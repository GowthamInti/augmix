...
parser.add_argument('--pretrained','-pt',type=bool,default=True,choices=[True,False],help='choice to choose for pre trained weights')
...
c_p_dir = '/home/g059598/augmix/augmix/data/cifar/' + c_p_dir
